        ...
        <div className="container">
          ...
          <div className="projects-note reveal" style={{ textAlign: "center", marginTop: "48px" }}>
            ...
            <p className="section-sub" style={{ margin: "0 auto", marginTop: "12px" }}>
              ...
              <span style={{ display: "inline-block" }}>選ばれるイラストレーターとしての力になります。</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="workflow" id="workflow">
        <div className="container">
          ...
          <div className="wf-steps-editorial">
            {[
              { img: "illust-wf-proposal.jpg", num: 1, title: "プロジェクト参画・世界観の共有", desc: "ディレクターから参画するプロジェクトのキャラクターデザインや作品の世界観が共有されます。チームで一本の作品を描き上げるため、まず全員が同じ絵柄・世界観を共有することから始まります。最初は慣れないかもしれませんが、絵柄を合わせる技術は、どんな案件にも応えられるイラストレーターとしての大きな武器になります。", note: "", reverse: false },
        ...
        <div className="container">
          ...
          <div className="env-items">
            {[
              ...
              { img: "illust-env-clipstudio.jpg", title: "【Clip Studio Paint】業界標準の制作ツール", desc: "Clip Studio Paintを使用。漫画・イラスト制作に特化した機能が揃っており、実際の制作現場と同じ環境で取り組めます。", cls: "reveal-right", reverse: true },
        ...
        <div className="container">
          ...
          <div className="faq-list">
            {[
              ...
              { q: "自分のイラストスタイルのままで描けますか？", a: "当スタジオの主な案件は、チームで一本の漫画動画を制作する仕事です。そのため、プロジェクトごとにクライアントやキャラクターデザインに合わせて絵柄を寄せていただく場面が多くなります。最初は戸惑う方もいらっしゃいますが、絵柄を柔軟に描き分けられる力は、どんな案件にも応えられるイラストレーターとしての大きな武器になります。ディレクターが一緒に丁寧にサポートしますので、ご安心ください。" },
